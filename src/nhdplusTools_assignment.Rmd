...
<span style="color: blue;">There are **`r nrow(clp_gages)`** gages in the Cache la Poudre River (CLP) watershed. The area of the CLP watershed is **`r st_area(clp_watershed)`**. </span>

...
<span style="color: blue;">The difference between the distance calculated using the `get_UT` and `get_DM` functions versus the distance calculated usint `get_pathlength` is **`r round(fnl_distance_pathlength$pathlength[1] - fnl_distance_gets$length[1], 3)` km**.</span>
